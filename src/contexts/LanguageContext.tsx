...
const TRANSLATIONS: Record<Language, Record<string, unknown>> = {
  fr: {
    ...
    hero: {
      ...
      seoMpaudioDesc: 'E-commerce, identité visuelle, UX/UI et motion design.',
    ...
    project: {
      ...
      audit: 'Audit',
      branding: 'Branding',
      pedagoTitle: "Présentation de l'entreprise",
      pedagoPhotoCredit: 'Photos —',
      pedagoPhotoCreditLink: 'Péda GO ! (pedago.re)',
  ...
  en: {
    ...
    hero: {
      ...
      seoMpaudioDesc: 'E-commerce, visual identity, UX/UI and motion design.',
